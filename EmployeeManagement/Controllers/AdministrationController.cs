    ...
    public class AdministrationController : Controller
    {
        ...
        public async Task<IActionResult> ManageUserClaims(UserClaimsViewModel model)
        {
            ...
            result = await userManager.AddClaimsAsync(user, 
                ...
                // If the claim type is selected, we want to store a value of TRUE for the claim value
        ...
        public async Task<IActionResult> EditRole(string id)
        {
            ...
            foreach (var user in userManager.Users.ToList())
            {
                ...
                {
                    //If the user is in the role, add their name to the list of username strings in the EditRoleViewModel
        ...
        public async Task<IActionResult> ManageUserRoles(List<UserRolesViewModel> model, string userId)
        {
            ...
            if (!result.Succeeded)
            {
                ModelState.AddModelError(string.Empty, "Cannot remove user's existing roles");
                return View(model);
            }
